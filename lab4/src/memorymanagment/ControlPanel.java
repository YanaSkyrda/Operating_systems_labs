...
public class ControlPanel extends Frame {
    ...
    java.util.List pagesButtons = new ArrayList<Button>();
    java.util.List labels = new ArrayList<Button>();
    ...
    public void init(Kernel useKernel, String commands, String config) {
        ...
        for (int i = 0; i < pagesButtons.size(); i++) {
            ...
            if (i < 32) {
                button.reshape(0, (i + 2) * 15 + 25, 70, 15);
            } else {
                button.reshape(140, ((i % 32) + 2) * 15 + 25, 70, 15);
            }
        ...
        for (int i = 0; i < labels.size(); i++) {
            ...
            if (i < 32) {
                label.reshape(70, (i + 2) * 15 + 25, 60, 15);
            } else {
                label.reshape(210, ((i % 32) + 2) * 15 + 25, 60, 15);
            }
